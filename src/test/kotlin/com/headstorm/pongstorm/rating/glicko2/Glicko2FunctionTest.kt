...
//    "Glicko2 example... Example"
    @test fun Glicko2_main_ex() {
        ...
        val outcome1 = GameOutcome(
                Player(2, 1400f, 0.06f, 30f),
                OutcomeType.WIN
        )
        val outcome2 = GameOutcome(
                Player(3, 1550f, 0.06f, 100f),
                OutcomeType.LOSE
        )
        val outcome3 = GameOutcome(
                Player(4, 1700f, 0.06f, 300f),
                OutcomeType.LOSE
        )

        val playerOut = calculatePlayerScoreGlicko(player, listOf(outcome1, outcome2, outcome3))
